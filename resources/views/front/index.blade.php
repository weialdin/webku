...
@section('content')
	...
	<body class="font-[Poppins] pb-[72px]">
		...
		<nav id="Category" class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]">
			...
			<a href="{{route('front.category', $menu->slug)}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18]">
				<div class="w-6 h-6 flex shrink-0">
					<img src="{{Storage::url($menu->icon)}}" alt="icon" />
				</div>
				<span>{{ $menu->name }}</span>
			</a>
			@endforeach
		...
		<section id="Up-to-date" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex justify-between items-center">
				<h2 class="font-bold text-[26px] leading-[39px]">
					Jelajahi Artikel Terbaru <i class="fa-solid fa-fire icon-terbakar" style="color: red;"></i>
				</h2>
				<p class="badge-orange rounded-full p-[8px_18px] bg-[#FFECE1] font-bold text-sm leading-[21px] text-[#FF6B18] w-fit"><i class="fa-solid fa-calendar-days"></i> UP TO DATE</p>
			</div>
		...
		<section id="Best-authors" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex flex-col text-center gap-[14px] items-center">
				<p class="badge-orange rounded-full p-[8px_18px] bg-[#FFECE1] font-bold text-sm leading-[21px] text-[#FF6B18] w-fit"><i class="fa-solid fa-user"></i> BEST AUTHORS</p>
				<h2 class="font-bold text-[26px] leading-[39px]">
					Artikel Dari Penulis Populer <i class="fa-regular fa-thumbs-up icon-terbakar" style="color: red;"></i>
				</h2>
			</div>
		...
		<section id="Latest-entertainment" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex justify-between items-center">
				<h2 class="font-bold text-[26px] leading-[39px]">
					Artikel Koding Terbaru <i class="fa-solid fa-laptop-code icon-terbakar" style="color: red;"></i>
				</h2>
				<a href="" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18]">Explore All <i class="fa-solid fa-arrow-right"></i></a>
			</div>
			<div class="flex justify-between items-center h-fit">
				<div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
					...
					<div class="card-detail w-full flex items-end p-[30px] relative z-20">
						<div class="flex flex-col gap-[10px]">
							<p class="text-white">Featured</p>
							<a href="{{ route('front.details', $article->slug) }}" class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{ $entertainment_featured_articles->name }}</a>
							<p class="text-white">
